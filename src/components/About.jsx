        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-dark-300 leading-relaxed mb-6">
              ...
              <span className="text-primary-400 font-medium">MEAN</span> and{" "}
              <span className="text-primary-400 font-medium">MERN</span> stacks,
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="flex items-center gap-4 p-5 rounded-xl bg-dark-900/50 border border-dark-800/50 hover:border-primary-500/30 transition-all group"
              >
