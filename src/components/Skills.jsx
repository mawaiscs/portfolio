        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillCategories.map((cat, catIndex) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-dark-900/50 border border-dark-800/50 hover:border-primary-500/30 transition-all duration-300 group"
            >
              ...
              <div className="space-y-3">
                {cat.skills.map((skill) => (
                  ...
                  >
                    <skill.icon className="text-dark-500 group-hover:text-primary-500/60 transition-colors shrink-0" />
