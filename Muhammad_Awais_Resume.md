...
| **Cloud & DevOps**     | AWS (EC2, S3, CloudFront), Google Cloud Run, Docker, Kubernetes, Nginx, CI/CD |
| **Tools & Practices**  | Git, Bitbucket, Jest, Postman, Jira, Agile/Scrum                              |

---

## 💼 &nbsp; PROFESSIONAL EXPERIENCE

### **Senior Software Engineer** &nbsp;—&nbsp; Callvio
...
- Integrated **Twilio** (SMS/voice), **Zoom SDK** (video consultations), and **payment gateways** for seamless third-party services
...
_Punjab University College of Information Technology (PUCIT), Lahore, Pakistan_
